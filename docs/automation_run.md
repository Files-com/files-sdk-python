...
```
files_sdk.automation_run.find_node(id, {
  "node_id": "node_id"
})
```
...
```
files_sdk.automation_run.cancel(id)
```
...
```
files_sdk.automation_run.rerun(id, {
  "node_id": "node_id"
})
```
...
```
automation_run = files_sdk.automation_run.find(id)
