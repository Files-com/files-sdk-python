...
class IpAddressTest(TestBase):
    ...
    @unittest.skipUnless(TestBase.mock_server_path_exists("GET", "/ip_addresses/active"), "Mock path does not exist")
    def test_get_active(self):
        resp = ip_address.get_active()
    ...
    @unittest.skipUnless(TestBase.mock_server_path_exists("POST", "/ip_addresses/active/create_export"), "Mock path does not exist")
    def test_active_create_export(self):
        resp = ip_address.active_create_export()
