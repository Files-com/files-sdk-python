...
class HistoryTest(TestBase):
    ...
    @unittest.skipUnless(TestBase.mock_server_path_exists("POST", "/history/files/create_export"), "Mock path does not exist")
    ...
    @unittest.skipUnless(TestBase.mock_server_path_exists("POST", "/history/folders/create_export"), "Mock path does not exist")
