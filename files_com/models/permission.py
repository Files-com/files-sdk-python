...
class Permission:
    ...
    def get_attributes(self):
        return {k: getattr(self, k, None) for k in Permission.default_attributes}
    ...
    def save(self):
        if hasattr(self, "path") and self.path:
            ...
            new_obj = Permission.do_create(self.get_attributes(), self.options)
    ...
    def do_list(path, params = {}, options = {}):
      ...
      # 
      #    Api.send_request("GET", "/permissions", params, options)
      #  end

    @staticmethod
    def do_all(path, params = {}):
        Permission.do_list(path, params)
