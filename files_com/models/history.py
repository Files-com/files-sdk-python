...
class History:
    ...
    def get_attributes(self):
        return {k: getattr(self, k, None) for k in History.default_attributes}
    ...
    @staticmethod
    def do_list_for_file(path, params = {}, options = {}):
      ...
      # 
      #    Api.send_request("GET", "/history/files/#{params[:path]}", params, options)
      #  end
    ...
    #   path (required) - string - Path to operate on.
    @staticmethod
    def do_list_for_folder(path, params = {}, options = {}):
        if not isinstance(params, dict):
            params = {}
        params["path"] = path
        if "start_at" in params and not isinstance(params["start_at"], str):
      ...
      # List.new(Action, params) do
      # 
      #    Api.send_request("GET", "/history/folders/#{params[:path]}", params, options)
      #  end
    ...
    @staticmethod
    def do_list_for_user(user_id, params = {}, options = {}):
        if not isinstance(params, dict):
            params = {}
      ...
      # List.new(Action, params) do
      # 
      #    Api.send_request("GET", "/history/users/#{params[:user_id]}", params, options)
      #  end
    ...
    #   sort_by - object - If set, sort records by the specified field in either 'asc' or 'desc' direction (e.g. sort_by[last_login_at]=desc). Valid fields are `user_id` and `created_at`.
    @staticmethod
    def do_list_logins(params = {}, options = {}):
        if "start_at" in params and not isinstance(params["start_at"], str):
            raise InvalidParameterError("Bad parameter: start_at must be an str")
        if "end_at" in params and not isinstance(params["end_at"], str):
            raise InvalidParameterError("Bad parameter: end_at must be an str")
      ...
      # List.new(Action, params) do
      # 
      #    Api.send_request("GET", "/history/login", params, options)
      #  end
    ...
    def do_list(params = {}, options = {}):
      ...
      # List.new(Action, params) do
      # 
      #    Api.send_request("GET", "/history", params, options)
      #  end

    @staticmethod
    def do_all(params = {}):
        History.do_list(params)
