...
class Bundle:
    ...
    def get_attributes(self):
        return {k: getattr(self, k, None) for k in Bundle.default_attributes}
    ...
    def share(self, params = {}):
        ...
        return Api.send_request("POST", "/bundles/{id}/share".format(id=params['id']), params, self.options)
    ...
    def delete(self, params = {}):
        ...
        if "id" in params and not isinstance(params["id"], int):
            raise InvalidParameterError("Bad parameter: id must be an int")
        return Api.send_request("DELETE", "/bundles/{id}".format(id=params['id']), params, self.options)
    ...
    def save(self):
        if hasattr(self, "id") and self.id:
            ...
            new_obj = Bundle.do_create(self.get_attributes(), self.options)
    ...
    def do_list(params = {}, options = {}):
      ...
      # 
      #    Api.send_request("GET", "/bundles", params, options)
      #  end

    @staticmethod
    def do_all(params = {}):
        Bundle.do_list(params)
    ...
    #   note - string - Note to include in email.
    @staticmethod
    def do_share(id, params = {}, options = {}):
        if not isinstance(params, dict):
            params = {}
        params["id"] = id
        if "id" in params and not isinstance(params["id"], int):
