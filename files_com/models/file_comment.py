...
class FileComment:
    ...
    def get_attributes(self):
        return {k: getattr(self, k, None) for k in FileComment.default_attributes}
    ...
    def update(self, params = {}):
        ...
        return Api.send_request("PATCH", "/file_comments/{id}".format(id=params['id']), params, self.options)
    ...
    def delete(self, params = {}):
        ...
        if "id" in params and not isinstance(params["id"], int):
            raise InvalidParameterError("Bad parameter: id must be an int")
        return Api.send_request("DELETE", "/file_comments/{id}".format(id=params['id']), params, self.options)
    ...
    def save(self):
        if hasattr(self, "id") and self.id:
            ...
            new_obj = FileComment.do_create(self.get_attributes(), self.options)
    ...
    @staticmethod
    def do_list_for(path, params = {}, options = {}):
        if not isinstance(params, dict):
            params = {}
        params["path"] = path
        ...
        response, options = Api.send_request("GET", "/file_comments/files/{path}".format(path=params['path']), params, options)
        return [ FileComment(entity_data, options) for entity_data in response.data ]
