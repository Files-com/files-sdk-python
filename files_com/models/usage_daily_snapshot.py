...
class UsageDailySnapshot:
    ...
    def get_attributes(self):
        return {k: getattr(self, k, None) for k in UsageDailySnapshot.default_attributes}
    ...
    def do_list(params = {}, options = {}):
      ...
      # 
      #    Api.send_request("GET", "/usage_daily_snapshots", params, options)
      #  end

    @staticmethod
    def do_all(params = {}):
        UsageDailySnapshot.do_list(params)
