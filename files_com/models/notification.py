...
class Notification:
    ...
    def get_attributes(self):
        return {k: getattr(self, k, None) for k in Notification.default_attributes}
    ...
    def update(self, params = {}):
        ...
        return Api.send_request("PATCH", "/notifications/{id}".format(id=params['id']), params, self.options)
    ...
    def delete(self, params = {}):
        ...
        if "id" in params and not isinstance(params["id"], int):
            raise InvalidParameterError("Bad parameter: id must be an int")
        return Api.send_request("DELETE", "/notifications/{id}".format(id=params['id']), params, self.options)
    ...
    def save(self):
        if hasattr(self, "id") and self.id:
            ...
            new_obj = Notification.do_create(self.get_attributes(), self.options)
    ...
    def do_list(params = {}, options = {}):
      ...
      # 
      #    Api.send_request("GET", "/notifications", params, options)
      #  end

    @staticmethod
    def do_all(params = {}):
        Notification.do_list(params)
