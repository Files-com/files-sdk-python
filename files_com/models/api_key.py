...
class ApiKey:
    ...
    def get_attributes(self):
        return {k: getattr(self, k, None) for k in ApiKey.default_attributes}
    ...
    def update(self, params = {}):
        ...
        return Api.send_request("PATCH", "/api_keys/{id}".format(id=params['id']), params, self.options)
    ...
    def delete(self, params = {}):
        ...
        if "id" in params and not isinstance(params["id"], int):
            raise InvalidParameterError("Bad parameter: id must be an int")
        return Api.send_request("DELETE", "/api_keys/{id}".format(id=params['id']), params, self.options)
    ...
    def save(self):
        if hasattr(self, "id") and self.id:
            ...
            new_obj = ApiKey.do_create(self.get_attributes(), self.options)
    ...
    def do_list(params = {}, options = {}):
      ...
      # 
      #    Api.send_request("GET", "/api_keys", params, options)
      #  end
