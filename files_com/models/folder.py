...
class Folder:
    ...
    def get_attributes(self):
        return {k: getattr(self, k, None) for k in Folder.default_attributes}
    ...
    def save(self):
        if hasattr(self, "path") and self.path:
            ...
            new_obj = Folder.do_create(self.get_attributes(), self.options)
    ...
    def do_list_for(path, params = {}, options = {}):
      ...
      # 
      #    Api.send_request("GET", "/folders/#{params[:path]}", params, options)
      #  end
