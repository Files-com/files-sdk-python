...
class RemoteServer:
    ...
    def get_attributes(self):
        return {k: getattr(self, k, None) for k in RemoteServer.default_attributes}
    ...
    def update(self, params = {}):
        ...
        return Api.send_request("PATCH", "/remote_servers/{id}".format(id=params['id']), params, self.options)
    ...
    def delete(self, params = {}):
        ...
        if "id" in params and not isinstance(params["id"], int):
            raise InvalidParameterError("Bad parameter: id must be an int")
        return Api.send_request("DELETE", "/remote_servers/{id}".format(id=params['id']), params, self.options)
    ...
    def save(self):
        if hasattr(self, "id") and self.id:
            ...
            new_obj = RemoteServer.do_create(self.get_attributes(), self.options)
    ...
    def do_list(params = {}, options = {}):
        ...
        response, options = Api.send_request("GET", "/remote_servers", params, options)
        return [ RemoteServer(entity_data, options) for entity_data in response.data ]

    @staticmethod
    def do_all(params = {}):
        RemoteServer.do_list(params)
