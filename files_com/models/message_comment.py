...
class MessageComment:
    ...
    def get_attributes(self):
        return {k: getattr(self, k, None) for k in MessageComment.default_attributes}
    ...
    def update(self, params = {}):
        ...
        return Api.send_request("PATCH", "/message_comments/{id}".format(id=params['id']), params, self.options)
    ...
    def delete(self, params = {}):
        ...
        if "id" in params and not isinstance(params["id"], int):
            raise InvalidParameterError("Bad parameter: id must be an int")
        return Api.send_request("DELETE", "/message_comments/{id}".format(id=params['id']), params, self.options)
    ...
    def save(self):
        if hasattr(self, "id") and self.id:
            ...
            new_obj = MessageComment.do_create(self.get_attributes(), self.options)
