...
class User:
    ...
    def get_attributes(self):
        return {k: getattr(self, k, None) for k in User.default_attributes}
    ...
    def unlock(self, params = {}):
        ...
        return Api.send_request("POST", "/users/{id}/unlock".format(id=params['id']), params, self.options)
    ...
    def resend_welcome_email(self, params = {}):
        ...
        if "id" in params and not isinstance(params["id"], int):
            raise InvalidParameterError("Bad parameter: id must be an int")
        return Api.send_request("POST", "/users/{id}/resend_welcome_email".format(id=params['id']), params, self.options)
    ...
    def user_2fa_reset(self, params = {}):
        ...
        if "id" in params and not isinstance(params["id"], int):
            raise InvalidParameterError("Bad parameter: id must be an int")
        return Api.send_request("POST", "/users/{id}/2fa/reset".format(id=params['id']), params, self.options)
    ...
    def update(self, params = {}):
        ...
        return Api.send_request("PATCH", "/users/{id}".format(id=params['id']), params, self.options)
    ...
    def delete(self, params = {}):
        ...
        if "id" in params and not isinstance(params["id"], int):
            raise InvalidParameterError("Bad parameter: id must be an int")
        return Api.send_request("DELETE", "/users/{id}".format(id=params['id']), params, self.options)
    ...
    def save(self):
        if hasattr(self, "id") and self.id:
            ...
            new_obj = User.do_create(self.get_attributes(), self.options)
    ...
    def do_list(params = {}, options = {}):
      ...
      # 
      #    Api.send_request("GET", "/users", params, options)
      #  end
    ...
    # Unlock user who has been locked out due to failed logins
    @staticmethod
    def do_unlock(id, params = {}, options = {}):
        if not isinstance(params, dict):
            params = {}
        params["id"] = id
        if "id" in params and not isinstance(params["id"], int):
    ...
    # Resend user welcome email
    @staticmethod
    def do_resend_welcome_email(id, params = {}, options = {}):
        if not isinstance(params, dict):
            params = {}
        params["id"] = id
        if "id" in params and not isinstance(params["id"], int):
    ...
    # Trigger 2FA Reset process for user who has lost access to their existing 2FA methods
    @staticmethod
    def do_user_2fa_reset(id, params = {}, options = {}):
        if not isinstance(params, dict):
            params = {}
        params["id"] = id
        if "id" in params and not isinstance(params["id"], int):
