...
class Behavior:
    ...
    def get_attributes(self):
        return {k: getattr(self, k, None) for k in Behavior.default_attributes}
    ...
    def update(self, params = {}):
        ...
        return Api.send_request("PATCH", "/behaviors/{id}".format(id=params['id']), params, self.options)
    ...
    def delete(self, params = {}):
        ...
        if "id" in params and not isinstance(params["id"], int):
            raise InvalidParameterError("Bad parameter: id must be an int")
        return Api.send_request("DELETE", "/behaviors/{id}".format(id=params['id']), params, self.options)
    ...
    def save(self):
        if hasattr(self, "id") and self.id:
            ...
            new_obj = Behavior.do_create(self.get_attributes(), self.options)
    ...
    def do_list(params = {}, options = {}):
      ...
      # 
      #    Api.send_request("GET", "/behaviors", params, options)
      #  end

    @staticmethod
    def do_all(params = {}):
        Behavior.do_list(params)
    ...
    def do_list_for(path, params = {}, options = {}):
      ...
      # List.new(Behavior, params) do
      # 
      #    Api.send_request("GET", "/behaviors/folders/#{params[:path]}", params, options)
      #  end
    ...
    @staticmethod
    def do_webhook_test(params = {}, options = {}):
