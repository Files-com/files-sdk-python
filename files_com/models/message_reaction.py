...
class MessageReaction:
    ...
    def get_attributes(self):
        return {k: getattr(self, k, None) for k in MessageReaction.default_attributes}
    ...
    def delete(self, params = {}):
        ...
        return Api.send_request("DELETE", "/message_reactions/{id}".format(id=params['id']), params, self.options)
    ...
    def save(self):
        if hasattr(self, "id") and self.id:
            ...
            new_obj = MessageReaction.do_create(self.get_attributes(), self.options)
    ...
    def do_list(params = {}, options = {}):
        ...
        response, options = Api.send_request("GET", "/message_reactions", params, options)
        return [ MessageReaction(entity_data, options) for entity_data in response.data ]
