...
class SsoStrategy:
    ...
    def get_attributes(self):
        return {k: getattr(self, k, None) for k in SsoStrategy.default_attributes}
    ...
    def do_list(params = {}, options = {}):
        ...
        response, options = Api.send_request("GET", "/sso_strategies", params, options)
        return [ SsoStrategy(entity_data, options) for entity_data in response.data ]

    @staticmethod
    def do_all(params = {}):
        SsoStrategy.do_list(params)
