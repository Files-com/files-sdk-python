...
class UserRequest:
    ...
    def get_attributes(self):
        return {k: getattr(self, k, None) for k in UserRequest.default_attributes}
    ...
    def delete(self, params = {}):
        ...
        return Api.send_request("DELETE", "/user_requests/{id}".format(id=params['id']), params, self.options)
    ...
    def save(self):
        if hasattr(self, "id") and self.id:
            ...
            new_obj = UserRequest.do_create(self.get_attributes(), self.options)
    ...
    def do_list(params = {}, options = {}):
        ...
        response, options = Api.send_request("GET", "/user_requests", params, options)
        return [ UserRequest(entity_data, options) for entity_data in response.data ]

    @staticmethod
    def do_all(params = {}):
        UserRequest.do_list(params)
