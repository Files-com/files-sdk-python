...
class HistoryExport:
    ...
    def get_attributes(self):
        return {k: getattr(self, k, None) for k in HistoryExport.default_attributes}
    ...
    def delete(self, params = {}):
        ...
        return Api.send_request("DELETE", "/history_exports/{id}".format(id=params['id']), params, self.options)
    ...
    def save(self):
        if hasattr(self, "id") and self.id:
            ...
            new_obj = HistoryExport.do_create(self.get_attributes(), self.options)
