...
class Session:
    ...
    def get_attributes(self):
        return {k: getattr(self, k, None) for k in Session.default_attributes}
    ...
    def save(self):
        if hasattr(self, "id") and self.id:
            ...
            new_obj = Session.do_create(self.get_attributes(), self.options)
