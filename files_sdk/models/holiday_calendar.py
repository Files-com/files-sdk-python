...
class HolidayCalendar:
    ...
    def set_attributes(self, attributes):
        for (
            attribute,
            default_value,
        ) in HolidayCalendar.default_attributes.items():
    ...
    def get_attributes(self):
        attrs = {
            ...
            for k in HolidayCalendar.default_attributes
...
def list(params=None, options=None):
    ...
    return ListObj(
        HolidayCalendar, "GET", "/holiday_calendars", params, options
    )
...
def find(id, params=None, options=None):
    ...
    response, options = Api.send_request(
        "GET",
        "/holiday_calendars/{id}".format(id=quote(str(params["id"]), safe="")),
        params,
        options,
    )
    return HolidayCalendar(response.data, options)
...
def create(params=None, options=None):
    ...
    response, options = Api.send_request(
        "POST", "/holiday_calendars", params, options
    )
    return HolidayCalendar(response.data, options)
...
def new(*args, **kwargs):
    return HolidayCalendar(*args, **kwargs)
