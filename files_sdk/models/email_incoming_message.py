...
class EmailIncomingMessage:
    ...
    def set_attributes(self, attributes):
        for (attribute, default_value) in EmailIncomingMessage.default_attributes.items():
            setattr(self, attribute, attributes.get(attribute, default_value))

    def get_attributes(self):
        return {k: getattr(self, k, None) for k in EmailIncomingMessage.default_attributes if getattr(self, k, None) is not None}
...
def list(params = None, options = None):
    ...
    return ListObj(EmailIncomingMessage,"GET", "/email_incoming_messages", params, options)
