...
class CustomDomain:
    ...
    def set_attributes(self, attributes):
        for (
            attribute,
            default_value,
        ) in CustomDomain.default_attributes.items():
    ...
    def get_attributes(self):
        attrs = {
            ...
            for k in CustomDomain.default_attributes
    ...
    def update(self, params=None):
        ...
        if "ssl_certificate_id" in params and not isinstance(
            params["ssl_certificate_id"], int
        ):
            raise InvalidParameterError(
                "Bad parameter: ssl_certificate_id must be an int"
            )
...
def find(id, params=None, options=None):
    ...
    response, options = Api.send_request(
        "GET",
        "/custom_domains/{id}".format(id=quote(str(params["id"]), safe="")),
        params,
        options,
    )
...
def create(params=None, options=None):
    ...
    response, options = Api.send_request(
        "POST", "/custom_domains", params, options
    )
    return CustomDomain(response.data, options)
...
def create_export(params=None, options=None):
    ...
    if "sort_by" in params and not isinstance(params["sort_by"], dict):
        raise InvalidParameterError("Bad parameter: sort_by must be an dict")
    response, options = Api.send_request(
        "POST", "/custom_domains/create_export", params, options
    )
...
def new(*args, **kwargs):
    return CustomDomain(*args, **kwargs)
