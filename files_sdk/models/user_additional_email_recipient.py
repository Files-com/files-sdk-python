...
class UserAdditionalEmailRecipient:
    default_attributes = {
        "id": None,  # int64 - User additional email recipient ID
        "user_id": None,  # int64 - User ID
        "workspace_id": None,  # int64 - Workspace ID (0 for default workspace).
        "email": None,  # string - Additional email recipient address
        "created_at": None,  # date-time - Created at date/time
    }
    ...
    def set_attributes(self, attributes):
        for (
            attribute,
            default_value,
        ) in UserAdditionalEmailRecipient.default_attributes.items():
    ...
    def get_attributes(self):
        attrs = {
            ...
            for k in UserAdditionalEmailRecipient.default_attributes
    ...
    def update(self, params=None):
        ...
        response, _options = Api.send_request(
            "PATCH",
            "/user_additional_email_recipients/{id}".format(
...
def find(id, params=None, options=None):
    ...
    return UserAdditionalEmailRecipient(response.data, options)
...
def create(params=None, options=None):
    ...
    response, options = Api.send_request(
        "POST", "/user_additional_email_recipients", params, options
    )
    return UserAdditionalEmailRecipient(response.data, options)
...
def new(*args, **kwargs):
    return UserAdditionalEmailRecipient(*args, **kwargs)
