...
class SftpHostKey:
    ...
    def get_attributes(self):
        return {k: getattr(self, k, None) for k in SftpHostKey.default_attributes if getattr(self, k, None) is not None}
    ...
    def update(self, params = None):
        ...
        response, _options = Api.send_request("PATCH", "/sftp_host_keys/{id}".format(id=params['id']), params, self.options)
    ...
    def delete(self, params = None):
        ...
        if "id" in params and not isinstance(params["id"], int):
            raise InvalidParameterError("Bad parameter: id must be an int")
        response, _options = Api.send_request("DELETE", "/sftp_host_keys/{id}".format(id=params['id']), params, self.options)
        return response.data
...
def find(id, params = None, options = None):
    ...
    if "id" not in params:
        raise MissingParameterError("Parameter missing: id")
    response, options = Api.send_request("GET", "/sftp_host_keys/{id}".format(id=params['id']), params, options)
...
def create(params = None, options = None):
    ...
    if "private_key" in params and not isinstance(params["private_key"], str):
        raise InvalidParameterError("Bad parameter: private_key must be an str")
    response, options = Api.send_request("POST", "/sftp_host_keys", params, options)
    return SftpHostKey(response.data, options)
...
def update(id, params = None, options = None):
    ...
    if "id" not in params:
        raise MissingParameterError("Parameter missing: id")
    response, options = Api.send_request("PATCH", "/sftp_host_keys/{id}".format(id=params['id']), params, options)
    return SftpHostKey(response.data, options)
...
def delete(id, params = None, options = None):
    ...
    if "id" not in params:
        raise MissingParameterError("Parameter missing: id")
    response, _options = Api.send_request("DELETE", "/sftp_host_keys/{id}".format(id=params['id']), params, options)
    return response.data
